...
import { Container, Typography, Card, CardContent, Grid2, CircularProgress, Alert, Button, Divider } from '@mui/material';
...
const ApplicationManager: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <Typography variant="h6" gutterBottom>Submitted Applications</Typography>
      <Divider sx={{ mb: 2 }} />
      <Grid2 container spacing={2}>
        {applications.map((app) => (
          <Grid2 key={app.applicationID} component="div">
            <Card>
              <CardContent>
