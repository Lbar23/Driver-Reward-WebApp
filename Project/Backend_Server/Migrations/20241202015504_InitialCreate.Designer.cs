...
namespace Backend_Server.Migrations
{
    ...
    [Migration("20241202015504_InitialCreate")]
            ...
            modelBuilder.Entity("Backend_Server.Models.FeedbackForms", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Alice",
                            SubmissionDate = new DateTime(2024, 12, 2, 1, 55, 4, 262, DateTimeKind.Utc).AddTicks(7186)
                        },
                        new
                        {
                            FeedbackID = 2,
                            ...
                            FirstName = "Bob",
                            SubmissionDate = new DateTime(2024, 12, 2, 1, 55, 4, 262, DateTimeKind.Utc).AddTicks(7188)
                        },
                        new
                        {
                            FeedbackID = 3,
                            ...
                            FirstName = "Charlie",
                            SubmissionDate = new DateTime(2024, 12, 2, 1, 55, 4, 262, DateTimeKind.Utc).AddTicks(7191)
                        },
                        new
                        {
                            FeedbackID = 4,
                            ...
                            FirstName = "Dana",
                            SubmissionDate = new DateTime(2024, 12, 2, 1, 55, 4, 262, DateTimeKind.Utc).AddTicks(7193)
                        });
                });
